...
fIn_mix = "/home/yshiba/immu_melanoma/im_m_rnaseq_fb_NKgenes_62_activated_transp_th2pc.csv"
...
for col in df[1:]:
    ...
    df_new = df[["official_gene_symbol", geneName]]
    print(df_new)
    df_new.to_csv("/home/yshiba/Redo_activated/im_m_rnaseq_fb_NKgenes_62_act_transp_th2pc_%s.csv" %geneName, sep=',', index=False)